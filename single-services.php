...
<div class="services">
	...
	?>
		...
		<div class="column text-center animated fadeInUp subService" style="-webkit-animation-delay: 0.<?php echo get_post_field( 'menu_order', $post->ID); ?>s;-moz-animation-delay: 0.<?php echo get_post_field( 'menu_order', $post->ID); ?>s;-ms-animation-delay: 0.<?php echo get_post_field( 'menu_order', $post->ID); ?>s;animation-delay: 0.<?php echo get_post_field( 'menu_order', $post->ID); ?>s;">
