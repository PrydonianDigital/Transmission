<?php
	...
	add_action( 'cmb2_init', 'post_author' );
	...
	function show_team() {
		...
		$section_group = $section->add_field( array(
			'id'			=> $prefix . 'section',
			'type'			=> 'group',
			'options'	 	=> array(
				'group_title'	=> __( 'Section {#}', 'mh' ),
				'add_button'	=> __( 'Add New Section', 'mh' ),
				'remove_button'	=> __( 'Remove Section', 'mh' ),
				'sortable'		=> true,
			),
		) );
		$section->add_group_field( $section_group, array(
			'id'				=> $prefix . 'icon',
			'title'				=> 'Icon',
			'type'				=> 'select',
			'options'			=> array(
	...
	function att_link() {
		return att_link_start( array( 'post_type' => 'team', 'numberposts' => -1 ) );
	}
